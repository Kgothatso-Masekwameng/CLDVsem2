...
namespace ABCRetailers.Services
{
    public class AzureStorageService : IAzureStorageService
    {
        ...
        public AzureStorageService()
        {
            ...
            var connectionString = "DefaultEndpointsProtocol=https;AccountName=saintmason;AccountKey=WcwydP0PPoxZHvVOUR2bxkhlk453kqCYPLT72QxadfjvVqNIXuzZVv9iQAGXJQod+dg1jrZDifye+ASt9uUh5g==;EndpointSuffix=core.windows.net;";
